// Но самым идеалогически правильным путем, 
//будет обеспечение синхронизации, используя каналы

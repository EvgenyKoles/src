// Go рутины, одновременно работающие с общими данными сами собой 
//не могу синхронизироваться
// Как пример защиты данных от небезопасных изменений, 
//можно использовать структуру Mutex
// У нее также нет публичных полей, но, есть два публичных метода
// Lock(), который даст только одной подпрограмме продолжить выполнение блока, 
//остальне заблокируются в ожидании
